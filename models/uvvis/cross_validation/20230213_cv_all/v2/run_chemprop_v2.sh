#!/bin/bash
#SBATCH -J uvvis_chemprop_v2
#SBATCH -o uvvis_chemprop_v2-%j.out
#SBATCH -t 5-00:00:00
#SBATCH -n 20
#SBATCH -N 1
#SBATCH --mem=30gb
...
python ../split.py --train_only_data $DATASETS_DIR/uvvis/v0/smiles_target_train.csv $DATASETS_DIR/uvvis/v0/smiles_target_val.csv --train_eval_data $DATASETS_DIR/uvvis/v1/v1.csv $DATASETS_DIR/uvvis/v2c/v2abc.csv --eval_only_data None --splits_dir splits_v2 --num_splits 5
...
--data_path splits_v2/split_$i/trainval.csv \
--separate_test_path splits_v2/split_$i/eval.csv \
